...
public class Sboard2Controller {
	...
	public String list(Model model,@RequestParam(value="pageNo",defaultValue="1") int pageNo) { //2) /board/list
		...
		@PostMapping("/write")
		public String wirte_post(MultipartFile file,Sboard2Dto dto,RedirectAttributes rttr) {
