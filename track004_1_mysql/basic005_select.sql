...
select no as '번호' ,name as '이름' ,age '나이' from userinfo;
...
select*from userinfo where age=null;
...
--  
--  22~23 살 사이
select*from userinfo where age>=22 and age<=33; -- 22~23살 사이
select*from userinfo where age  between 22 and 33; -- 22~23살 사이
select*from userinfo where age not between 22 and 33; -- 22~23살 사이가 아닌
select*from userinfo where age=22 or age=44; -- 22이거나 44살 (or)
select*from userinfo where age in(22,44);-- 22이거나 44살 (in)
select*from userinfo where age not in(22,44); -- 22,44살 사이가 아닌

select*from userinfo where name like 'f%'; -- 이름이 f로 시작하는
select*from userinfo where name not like 'f%'; -- 이름이 f로 시작하지 않는alter

-- age 값이 없는 애들
select*from userinfo where age is null; -- age 값이 없는애들
select*from userinfo where age is not null; -- age 값이 있는애들
select*from userinfo;
