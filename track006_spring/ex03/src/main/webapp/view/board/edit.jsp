   ...
   <div class="container  my-5">
      ...
      <form  action ="${pageContext.request.contextPath}/board/edit.do?bno=${dto.bno}" 
       method="post" enctype="multipart/form-data"    onsubmit="return checkForm()">
      	...
      	<div  class="my-3">
      		<label for="bcontext"  class="form-label">내용</label>
      		<textarea  class="form-control"    id="bcontext"  name="bcontext"  >${dto.bcontext}</textarea>
      	</div>
      	<div class="my-3">
         <label for="bfile"   class="form-label">기존 파일</label>
         ...
         <input type="file"  id="file"  name="file"   class="form-control"/>
      	...
      	<div  class="my-3  text-end"> 
      		...
      		<a href="${pageContext.request.contextPath}/board/list.do?bno=${dto.bno}"            class="btn btn-outline-success"  title="목록보러가기">목록</a>
