...
<!-- 	header		 -->
   <div class="container  my-5">
      ...
      <form  action ="${pageContext.request.contextPath}/board/write.do"  method="post"  enctype="multipart/form-data"   onsubmit="return checkForm()">
      	<div  class="my-3">
      	...
      	<div  class="my-3">
      		...
      		<textarea  class="form-control"    id="bcontext"  name="bcontext"  ></textarea>
      	</div>
      	<div class="my-3">
