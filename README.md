...
|-|-|
|name|하혜원|
|EMAIL	|hahy0117@gmail.com|
|GITHUB|	https://github.com/hahy0117/2026-AI-FULLSTACK.git|
...
|HTML + CSS + JS / JQUERY + AJAX	|DOM트리, 이벤트 루프 등 브라우저 동작 이해. **접근성, SEO, 비동기 통신 활용 능력.**|	
