■ Javascript
1. js 선택자 
1-1. id 선택자 사용시 document.getElementsById
1-2. 태그 선택자  document.getElementsByTagName
1-3. css 표현 선택자 사용시 document.query.Selector
...
■ OOP
1.  생성자   - new 연산자에 의해 호출 [ 객체생성      ] 담당

2. 기본생성자( 디폴트생성자 )
- 모든클래스에 생성자가 반드시 존재
- 생성자선언을 생략시 컴파일러가 자동으로 기본생성자를 추가
- 개발자가 선언시 컴파일러가 자동생성  (   취소하는 역할     )
