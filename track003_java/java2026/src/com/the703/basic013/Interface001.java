...
interface Animal2{
	String company="(주) 메가스터디"; //sf: ststic final- Animal2.company (클래스변수) method area,new 관련X ,this 각각 X
...
1) abstract -인스턴스 변수,일반메서드,추상메서드 가질 수 있으나
2) interface - 상수(public static final) +  추상메서드(public abstract)

3. 프로젝트 진행시 interface 사용함ㄴ
