...
public class Operator001 {
	...
	public static void main(String[] args) {
		...
		//Q1. 나머지 -짝수니?홀수니?(2) n%2 나머지 : 0 1
		//                    0       1       0       1
		System.out.println("Q1."+0%2+"\t"+2%2+"\t"+3%2);
		//Q2. 3의 배수? a가 3의배수니? / b가 3의 배수니?
		...
		//■3. 조건 &&(모든 조건을 만족시) ||(여러조건중에서 하나라도 만족하면 True)
		...
		//■4.삼항연산자 조건? 참: 거짓 
		String anser= a==10? "10이다" : "10이 아니다" ;
		...
		System.out.println( b1++); //1 출력한 다음 증가
