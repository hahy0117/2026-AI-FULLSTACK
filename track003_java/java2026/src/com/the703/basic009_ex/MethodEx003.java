...
public class MethodEx003 {
	...
	public static int myadd(int num,int num2) {
	 return num+num2;
	}
	public static String myban(char a) {
		...
		if(a=='A') {
			ad="노랑조";
			//System.out.println("노랑조");
		}else if(a=='B') {
			ad="주황조";
			//System.out.println("주황조");
		}
		return ad;
	}
	...
	public static void main(String[] args) {
		System.out.println("내가 좋아하는 숫자:"+return_num());
		System.out.println("2. 10/3.0을 실수로 표현"+return_float());
		System.out.println("3.가장 좋아하는색:"+mycolor());
