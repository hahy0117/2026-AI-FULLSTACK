...
public class DataType001 {
	...
	public static void main(String[] args) {
		...
		float fp3 = 1.11111111f; //0 7개 +1 =8개 - 급사값
		System.out.println(fp1 +"/t" +fp2+"/t"+fp3);
		//           1.0000001        1.0       1.1111112
		
		double dp1 = 1.000000000000001; //0 14개 + 1 =15개
		double dp2 = 1.0000000000000001;//0 15개 + 1 =16개
		double dp3 = 1.111111111111111; //0 15개 + 1 =16개
