...
public class Network003_book {
	...
	public static void main(String[] args) {
		try {
			...
			conn.setRequestProperty("X-Naver-Client-Id","CvGWWjRGBMxtzkH8zSop");
			conn.setRequestProperty("X-Naver-Client-Secret","ZR0LbD11mE");
...
/*
1.네이버개발자-로그인
 Client ID: CvGWWjRGBMxtzkH8zSop 
 Client Secret: ZR0LbD11mE
