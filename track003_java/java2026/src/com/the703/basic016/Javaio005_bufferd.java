...
public class Javaio005_bufferd {

	public static void main(String[] args) throws IOException {
		//#1.경로
		
		  String folder_rel = "src/com/the703/basic016/";  // 상대경로- 현재작업 폴더기준 src/com/the703/basic016/Javaio005_bufferd.java
	      String file_path  = "io005_buffered.txt";
	      
	      File folder = new  File(folder_rel);
	      File file   = new  File(folder_rel + file_path);   
		
		//#2.폴더+파일만들기 (mkdirs/creatNExFile)
		...
		//2) new OutputStramWriter( 인코딩에 맞춰서 문자)
		//3) new BufferedWriter( 속도향상 ) (abc->abc)
		BufferedWriter bw=
		new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file) ) );
		bw.write("1.while,1200\n");
