...
//////////////////////////////////////////////////
// 듣기★-InputStream >프로그램기준>OutputStream-말하기
...
/*
 * 1.Http 통신- 단방향(client 요정이 있을때,server 응답하고 연결 종료) 2.Socket통신 - 양방향(특정포트를 통해
 * 실시간으로 정보를 주고 받음-tcp/udp) 3.소켓통신흐름 1)서버소켓(as 센터),포트바인딩(문열기) 2)클라이언트 연결 요청,수락
 * 3)클라이언 소켓 (socket) 상담사(socket) 가 읽어들이기((상담사기준)InputStream
 * >프로그램기준>((Client)OutputStream)
 * 
 * 
 */
