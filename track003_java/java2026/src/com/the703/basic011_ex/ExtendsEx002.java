...
class MobileNote8 extends MobileNote7{
	private String face;                 void newShow() {
...
class MobileNote9 extends MobileNote8{
	private int battery  ;                 public MobileNote9(String iris, String face, int battery) {
...
//        my9.setBattery(24);
//        my9.newShow();
		MobileNote my9=new MobileNote9("brown","pretty",24*7);
		my9.newShow();
    }
