...
id,한 번 초기화되면 변경불가,this.id=++accountCount; 초기화

Q5. Account.accountCount의 값은 얼마인가? 왜 그렇게 되는지 설명하시오.
값:2
Account.accountCount 클래스변수
Account 객체가 2개, 생성될때마다 기본생성자가 호출되서
...
변수: 값 변경 불가(상수), 메서드: 오버라이딩 불가, 클래스: 상속 불가

Q10. 캡슐화의 장점은 무엇인가?
데이터를 보호 할 수 있다(외부에서 직접 접근하는 것을 차단)
유지보수 용이(내부 구현변경시 외북 영향 최소화)
