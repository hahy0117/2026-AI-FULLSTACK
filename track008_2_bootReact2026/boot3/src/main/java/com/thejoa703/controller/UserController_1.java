...
//
//@Tag(name="User Api",description="회원 인증 및 관련 API (Session & Swagger 지원)") // swagger
...
//	}
//	//닉네임중복확인
//	@Operation(summary="닉네임 중복 확인",description="사용자 ID로 특정회원정보를 조회합니다.")
...
//	
//	//마이페이지
//		@Operation(summary="마이페이지 조회",description="세션기반으로 현재 로그인도니 사용자의 정보를 조회")
//		@GetMapping("/me")
...
//				@Parameter(description="사용자ID") @PathVariable("userId") Long userId,
